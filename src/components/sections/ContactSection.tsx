                    ...
                    <div className="group">
                        <Card className="p-8 bg-card/50 backdrop-blur-sm border border-dashed border-border/50 group-hover:border-primary transition-all duration-300">
                            ...
                            <div className="space-y-6">
                                <a href={`mailto:${email}`} className="flex items-center gap-4 group/item p-3 rounded-lg hover:bg-muted/50 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-mono text-base group-hover/item:text-primary transition-colors">{email}</p>
                                    </div>
                                </a>
                                <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group/item p-3 rounded-lg hover:bg-muted/50 transition-colors">
                                    <Button variant="outline" size="icon" className="h-14 w-14 flex-shrink-0">
                                    <Github className="h-6 w-6"/>
                                    </Button>
                                    <div>
                                        <p className="font-headline text-muted-foreground text-sm">GitHub</p>
                                        <p className="font-mono text-base group-hover/item:text-primary transition-colors">{GITHUB_URL.replace('https://', '')}</p>
                                    </div>
                                </a>
                                <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group/item p-3 rounded-lg hover:bg-muted/50 transition-colors">
                                    <Button variant="outline" size="icon" className="h-14 w-14 flex-shrink-0">
                                        <Linkedin className="h-6 w-6"/>
                                    </Button>
                                    <div>
                                        <p className="font-headline text-muted-foreground text-sm">LinkedIn</p>
                                        <p className="font-mono text-base group-hover/item:text-primary transition-colors">{LINKEDIN_URL.replace('https://www.', '')}</p>
                                    </div>
                                </a>
                            </div>
                        </Card>
