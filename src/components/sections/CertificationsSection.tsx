            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {CERTIFICATIONS.map((cert) => (
                        ...
                        >
                            <Card className="h-full transition-all duration-300 hover:border-foreground hover:shadow-2xl hover:-translate-y-2 bg-card/80 backdrop-blur-sm border-dashed">
                                <CardHeader>
