            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-10">
                    <div className="md:col-span-1">
                        <h3 className="font-bold font-headline text-xl mb-4">My Philosophy</h3>
                    </div>
                 ...
                 <div className="grid md:grid-cols-3 gap-10 mt-16">
                    <div className="md:col-span-1">
                        <h3 className="font-bold font-headline text-xl mb-4">Competencies</h3>
                    </div>
                    <div className="md:col-span-2 space-y-6">
                        {SKILLS.map((skill) => (
                             <div key={skill.title}>
                                <h4 className="font-headline text-sm font-bold mb-3">{skill.title}</h4>
                                <p className="text-muted-foreground leading-relaxed">{skill.technologies}</p>
                            </div>
                        ))}
                    </div>
                </div>
